...
import com.learn.spring.ProjectService.JpaEmpService;

import jakarta.validation.Valid;

//@ResponseBody+@Controller
@RestController
public class JpaRepoCrudController
{
	//http://localhost:9090/jpaEmp
	
	@Autowired
	private JpaEmpService empService;
	
	private final Logger log = LoggerFactory.getLogger(JpaRepoCrudController.class);
